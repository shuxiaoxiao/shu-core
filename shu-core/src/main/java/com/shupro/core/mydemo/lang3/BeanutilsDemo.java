...
public class BeanutilsDemo {
    ...
    public static BeanutilsDemo m = new BeanutilsDemo();
    ...
    public static void main(String[] args) {
        ...
        HotelDto hotelDto = BeanutilsDemo.convertObjectFromObject(HotelDto.class, hotel);
        Debug.println(hotelDto.getDs(), hotelDto.getHotelName(), hotelDto.getHotelId(), hotel.getDs());
        Debug.println("==================");
        List<Hotel> list = new ArrayList<Hotel>();
        list.add(hotel);
 
        List<HotelDto> dtoList = BeanutilsDemo.convertObjectListFromObjectList(HotelDto.class, list);
